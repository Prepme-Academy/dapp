...
import { RenderExamLogo } from "@/components/dashboard/practice";
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-[320px_1fr] xxl:grid-cols-[420px_1fr] gap-4 items-start justify-start">
        <div className="w-full flex flex-col items-start justify-start gap-3">
          ...
          <Card className="w-full p-3 border-grey-500 space-y-3 flex flex-col items-start justify-start group hover:cursor-pointer">
            <CardHeader className="px-0 py-0 items-start justify-start flex-row gap-3 space-y-0 w-full">
              ...
              <div className="flex flex-col items-start justify-start gap-2 flex-grow">
                ...
                <div className="p-0 flex items-start justify-between gap-x-3 w-full">
          ...
          <Card className="w-full p-3 border-grey-500 space-y-3 flex flex-col items-start justify-start">
            ...
            <CardContent className="p-0 grid grid-cols-1 md:grid-cols-2 items-start gap-4 w-full">
              <Card className="w-full p-3 min-h-14 border-primary-400 shadow-[0px_1px_0px_0px_#1877f2] space-y-3 flex flex-col items-center justify-center">
                <div className="flex items-center justify-start gap-2">
                  <svg
                    width="16"
                    height="17"
          ...
          <Card className="w-full p-3 bg-white border-grey-200 space-y-3 flex flex-col items-start justify-start">
            <h3 className="text-sm font-normal text-muted-500 text-center flex items-center justify-start gap-2">
              <Image
