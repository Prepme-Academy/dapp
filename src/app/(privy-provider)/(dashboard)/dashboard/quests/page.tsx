...
export default function QuestsPage() {
  return (
    <section className="space-y-4">
      <h1 className="text-lg md:text-xl font-medium text-muted-500">Quests</h1>
      <section className="w-full rounded-lg flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between p-4 bg-adbg bg-no-repeat bg-cover">
        <div className="flex items-start justify-start gap-2 w-fit">
          ...
          <div className="flex flex-col items-start justify-start gap-2">
            <h2 className="text-start text-lg font-medium text-white">
              Unlock NFTs
            </h2>
