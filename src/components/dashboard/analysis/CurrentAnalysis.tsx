...
import { PracticeModal, RenderExamLogo } from "../practice";
...
const CurrentAnalysis: React.FC = () => {
  ...
  return (
    <Dialog>
      <Card className="w-full p-3 border-grey-500 flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-start lg:justify-between">
        ...
        <div className="grid grid-cols-2 align-top gap-4">
          <div className="flex items-center justify-start gap-2">
            ...
            <span className="text-xs font-normal text-muted-400">30 mins</span>
          </div>
          <div className="flex items-center justify-start gap-2">
            <svg
              width="17"
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <Button
            variant={"unstyled"}
            onClick={() =>
              router.push(`/dashboard/analysis/detail/${"jamb_chemistry_2020"}`)
            }
      ...
      {examQuestions && <PracticeModal examDetail={examQuestions[0]} />}
    </Dialog>
  );
};
