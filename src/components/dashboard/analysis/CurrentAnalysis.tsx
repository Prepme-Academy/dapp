  ...
  if (!examData) {
    return (
      <div className="w-full flex flex-col items-center justify-center">
        <Card className="w-full p-4 md:p-8 border-grey-500 space-y-4">
          <div className="flex flex-col md:flex-row items-start justify-start text-start gap-6">
            {/* Icon */}
            ...
            <div className="space-y-3">
              <h3 className="text-xl font-medium text-muted-500">
                No Exam Analysis Yet
              </h3>
              <p className="text-muted-400 text-sm">
                Start your learning journey by taking practice exams. Track your
                progress, identify areas for improvement, and boost your
                performance.
              </p>
            </div>
          </div>
          <Button
            ...
            className="bg-primary-400 text-white w-fit px-6 h-10 gradient-border shadow-buttonshadow outline-none text-sm font-medium hover:opacity-85 transition-all duration-300"
          >
    ...
    <Card className="w-full p-3 border-grey-500 flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-start lg:justify-between">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Button
          variant={"unstyled"}
          onClick={() =>
            router.push(`/dashboard/analysis/detail/${examData.id}`)
          }
