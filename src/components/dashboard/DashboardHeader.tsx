        ...
        {userInfoLoading ? (
          ...
          <div className="flex items-center justify-end gap-x-5">
            ...
            <Button
              ...
              onClick={() =>
                router.push(`/dashboard/streak/${fetchedUserInfo?.id}`)
              }
            >
              <Image
                ...
                >
                  <span className="uppercase">
                    {fetchedUserInfo?.username
                      ? fetchedUserInfo.username[0]
                      : "u"}
                  </span>
                </div>
                <span>{fetchedUserInfo?.username || "username"}</span>
              </PopoverTrigger>
              {!ready ? (
                <SkeletonLoader />
              ) : (
                    ...
                    /> */}
                      ...
                      <div className="flex flex-col items-start justify-start gap-1">
                        ...
                        <p className="text-sm font-normal text-muted-400">
                          {formatWalletAddress(
                            fetchedUserInfo?.walletAddress || dummyAddress
                          )}
                        </p>
                      </div>
                    </div>
...
const HeaderSkeletonLoader = () => {
  return (
    <div className="flex items-center justify-end gap-x-5">
      {/* Beginner Button Skeleton */}
      <Button
        variant="unstyled"
        className="bg-gray-200 w-[120px] h-10 rounded-full animate-pulse flex items-center justify-start gap-3"
        disabled
      >
      ...
      <Button
        variant="outline"
        className="w-[80px] h-10 animate-pulse bg-gray-200 border-gray-200"
        disabled
      >
        <div className="w-[18px] h-[18px] bg-gray-300 rounded-full" />
        <div className="w-8 h-4 bg-gray-300 rounded ml-2" />
      </Button>

      {/* XP Button Skeleton */}
      <Button
        variant="outline"
        className="w-[100px] h-10 animate-pulse bg-gray-200 border-gray-200"
        disabled
      >
        <div className="w-[18px] h-[18px] bg-gray-300 rounded-full" />
      ...
      <Button
        variant="outline"
        className="h-10 w-[140px] animate-pulse bg-gray-200 border-gray-200 flex items-center gap-2"
        disabled
      >
...
export const SkeletonLoader: React.FC = () => <div className="hidden" />;
