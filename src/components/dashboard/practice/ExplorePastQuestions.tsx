        ...
        {examQuestions.map((option) => (
          ...
          >
            ...
            <CardContent className="p-0 flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between gap-y-3">
              ...
              <div className="lg:translate-x-5 opacity-0 invisible lg:group-hover:opacity-100 lg:group-hover:visible transition-all duration-300">
                <Button
                  variant={"unstyled"}
                  className="bg-primary-400 text-white w-fit h-9 gradient-border shadow-buttonshadow outline-none text-sm font-medium hover:opacity-85 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                >
                  Practice
                </Button>
              </div>
